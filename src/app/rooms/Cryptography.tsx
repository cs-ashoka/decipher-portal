  ...
  return (
    <Page>
      ...
      {numberDetails && (
        ...
        >
          <div
            ...
            onClick={() => setNumberDetails(false)}
          >
            Close
          </div>
          <div
      ...
      <div style={{ display: 'flex' }}>
        ...
        <object data={roomImage} type="image/svg+xml" height={600}></object>
        <object
          data={safe}
          type="image/svg+xml"
